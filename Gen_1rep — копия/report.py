...
#
selected_columns = ['Служебный идентификатор', 'Дата поступления заявки', '2.7 Дата проведения эксперимента', 'Наименование материала', 'Толщина, мм',
                    'Группа воспламеняемости (декларируемая)', '2.15 Установленная группа воспламеняемости', '2.16 Соответствие декларируемой группе воспламеняемости']
column_new_name = {'Служебный идентификатор': '№ Заявки', '2.7 Дата проведения эксперимента': 'Дата проведения эксперимента',
                    '2.15 Установленная группа воспламеняемости': 'Группа воспламеняемости (установленная)', '2.16 Соответствие декларируемой группе воспламеняемости': 'Соответствие'}

df_sel = SelectAndFilter(merged_df, selected_columns, '2.16 Соответствие декларируемой группе воспламеняемости',
                         'Не соответствует', rep_file, 'Воспламеняемость_соответствие', dict_to_rename=column_new_name)
# ColorMark(rep_file, 'Воспламеняемость_соответствие', 'Не соответствует', 'Соответствует')
...
df_sel2 = SelectAndFilter(d_f=merged_df, select_column=selected_columns2, column_name='ЕКН', filters=500464, file_nam=rep_file, sheet_nam='Саларьево', dict_to_rename=column_to_rename)


Picator(df_sel2, 'Плотность теплового потока', 'Время воспламенения', 'Плотность теплового потока, кВт/м^2',
