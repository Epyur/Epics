...
def flamability():
    ...
    ser2 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 2].copy().set_index('ID').add_suffix('_ser2')
    ser3 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 3].copy().set_index('ID').add_suffix('_ser3')
    ser4 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 4].copy().set_index('ID').add_suffix('_ser4')
    ser5 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 5].copy().set_index('ID').add_suffix('_ser5')
    ser6 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 6].copy().set_index('ID').add_suffix('_ser6')
    ser7 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 7].copy().set_index('ID').add_suffix('_ser7')
    ser8 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 8].copy().set_index('ID').add_suffix('_ser8')
    ser9 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 9].copy().set_index('ID').add_suffix('_ser9')
    ser10 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 10].copy().set_index('ID').add_suffix('_ser10')
    ser11 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 11].copy().set_index('ID').add_suffix('_ser11')
    ser12 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 12].copy().set_index('ID').add_suffix('_ser12')
    ser13 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 13].copy().set_index('ID').add_suffix('_ser13')
    ser14 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 14].copy().set_index('ID').add_suffix('_ser14')
    ser15 = flam_df_shortened.loc[flam_df_merged['exp_num'] == 15].copy().set_index('ID').add_suffix('_ser15')
